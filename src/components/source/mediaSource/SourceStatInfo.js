    ...
    <StatBar
      ...
      stats={[
        ...
        { message: localMessages.geoPct,
          data: sourceInfo.geoPct ? formatNumber(sourceInfo.geoPct, { style: 'percent', maximumFractionDigits: 0 }) : '?',
          helpTitleMsg: messages.entityHelpTitle,
          helpContentMsg: messages.entityHelpContent,
        },
        { message: localMessages.nytPct,
          data: sourceInfo.nytPct ? formatNumber(sourceInfo.nytPct, { style: 'percent', maximumFractionDigits: 0 }) : '?',
