...
from server.util.request import api_error_handler, form_fields_required, arguments_required, api_error_handler
...
def topic_personal():
    ...
    results['topics'] = add_user_favorite_flag_to_topics(results['topics'])
