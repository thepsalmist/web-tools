...
BrowseStoriesContainer.ROWS_PER_PAGE = 50;
...
const mapStateToProps = (state, ownProps) => ({
  links: state.topics.selected.provider.stories.results.topicExplore ? state.topics.selected.provider.stories.results.topicExplore.link_ids : {},
