...
class WebMediaCloudProvider(ContentProvider):
    ...
    @classmethod
    def _format_as_q_and_fq(self, query: str, start_date: dt.datetime, end_date: dt.datetime, kwargs: Dict) -> (str, str):
        """
    ...
    def sample(self, query: str, start_date: dt.datetime, end_date: dt.datetime, limit: int = 20, **kwargs) -> List[Dict]:
        ...
        :return:
        """
        q, fq = self._format_as_q_and_fq(query, start_date, end_date, **kwargs)
